...
-(BOOL) setUpWriter {
	...
	NSDictionary* videoCompressionProps = [NSDictionary dictionaryWithObjectsAndKeys:
										   [NSNumber numberWithDouble:size.width * size.height * scale * scale], AVVideoAverageBitRateKey,
										   nil ];
	
	NSDictionary* videoSettings = [NSDictionary dictionaryWithObjectsAndKeys:
								   AVVideoCodecH264, AVVideoCodecKey,
								   [NSNumber numberWithInt:size.width * scale], AVVideoWidthKey,
								   [NSNumber numberWithInt:size.height * scale], AVVideoHeightKey,
    ...
    if (context== NULL)
    {
        ...
        CGAffineTransform flipVertical = CGAffineTransformMake(1, 0, 0,-1, 0, size.height * scale);
